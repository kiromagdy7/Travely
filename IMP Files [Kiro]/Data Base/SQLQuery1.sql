USE [master]
GO
/****** Object:  Database [TravelyDB]    Script Date: 12/6/2025 6:49:46 PM ******/
...
USE [TravelyDB]
GO
/****** Object:  Table [dbo].[lkpAmenities]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tblBookings]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblHotelAmenities]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblHotelImages]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblHotels]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblNotifications]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblPayments]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblReviews]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblRoomImages]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblRooms]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblUserHotelBooking]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblUsers]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWishList]    Script Date: 12/6/2025 6:49:46 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[tblBookings] ([booking_id], [user_id], [room_id], [check_in], [check_out], [status], [total_price], [booking_reference], [adults], [children], [created_at]) VALUES (6, 10, 2, CAST(N'2025-11-26' AS Date), CAST(N'2025-11-27' AS Date), N'Confirmed', CAST(1300.00 AS Decimal(12, 2)), N'BK-20251124020242-3e32', 1, 0, CAST(N'2025-11-24T02:02:42.3880204' AS DateTime2))
GO
INSERT [dbo].[tblBookings] ([booking_id], [user_id], [room_id], [check_in], [check_out], [status], [total_price], [booking_reference], [adults], [children], [created_at]) VALUES (7, 10, 3, CAST(N'2025-11-27' AS Date), CAST(N'2025-11-28' AS Date), N'Confirmed', CAST(2700.00 AS Decimal(12, 2)), N'BK-20251125230144-ec18', 1, 0, CAST(N'2025-11-25T23:01:44.6915982' AS DateTime2))
GO
INSERT [dbo].[tblBookings] ([booking_id], [user_id], [room_id], [check_in], [check_out], [status], [total_price], [booking_reference], [adults], [children], [created_at]) VALUES (8, 10, 3, CAST(N'2025-11-29' AS Date), CAST(N'2025-12-26' AS Date), N'Confirmed', CAST(72900.00 AS Decimal(12, 2)), N'BK-20251125231448-4542', 1, 0, CAST(N'2025-11-25T23:14:48.7070646' AS DateTime2))
GO
...
GO
INSERT [dbo].[tblNotifications] ([notification_id], [user_id], [title], [message], [notification_type], [is_read], [created_at]) VALUES (4, NULL, N'test', N'testtesttesttesttesttest', N'All', 1, CAST(N'2025-11-10T06:46:18.250' AS DateTime))
GO
INSERT [dbo].[tblNotifications] ([notification_id], [user_id], [title], [message], [notification_type], [is_read], [created_at]) VALUES (5, NULL, N'test 2', N'test 2', N'Admin', 0, CAST(N'2025-11-10T06:46:40.613' AS DateTime))
GO
INSERT [dbo].[tblNotifications] ([notification_id], [user_id], [title], [message], [notification_type], [is_read], [created_at]) VALUES (6, NULL, N'test C', N' Customers Customers Customers Customers Customers Customers Customers ', N'User', 1, CAST(N'2025-11-10T06:47:39.523' AS DateTime))
GO
INSERT [dbo].[tblNotifications] ([notification_id], [user_id], [title], [message], [notification_type], [is_read], [created_at]) VALUES (7, NULL, N'test staff', N'staff test', N'Staff', 0, CAST(N'2025-11-10T06:52:02.173' AS DateTime))
GO
...
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (19, 1, N'/images/rooms/20251104203850_1_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (20, 2, N'/images/rooms/20251104203902_2_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (22, 4, N'/images/rooms/20251104203924_4_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (23, 5, N'/images/rooms/20251104203932_5_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (24, 6, N'/images/rooms/20251104203944_6_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (25, 7, N'/images/rooms/20251104203957_7_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (26, 8, N'/images/rooms/20251104204011_8_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (27, 9, N'/images/rooms/20251104204026_9_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (28, 10, N'/images/rooms/20251104204039_10_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (29, 11, N'/images/rooms/20251104204053_11_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (30, 12, N'/images/rooms/20251104204109_12_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (31, 13, N'/images/rooms/20251104204206_13_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (33, 13, N'/images/rooms/20251104212039_13_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (34, 13, N'/images/rooms/20251104212039_13_2.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (35, 13, N'/images/rooms/20251104212039_13_3.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (36, 1, N'/images/rooms/20251107231300_1_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (37, 1, N'/images/rooms/20251107231300_1_2.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (38, 1, N'/images/rooms/20251107231300_1_3.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (39, 1, N'/images/rooms/20251107231300_1_4.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (40, 2, N'/images/rooms/20251107232055_2_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (41, 2, N'/images/rooms/20251107232055_2_2.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (42, 2, N'/images/rooms/20251107232055_2_3.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (43, 2, N'/images/rooms/20251107232055_2_4.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (49, 3, N'/images/rooms/20251107232150_3_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (50, 3, N'/images/rooms/20251107232218_3_1.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (51, 3, N'/images/rooms/20251107232218_3_2.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (52, 3, N'/images/rooms/20251107232218_3_3.webp')
GO
INSERT [dbo].[tblRoomImages] ([image_id], [room_id], [image_url]) VALUES (53, 3, N'/images/rooms/20251107232218_3_4.webp')
GO
SET IDENTITY_INSERT [dbo].[tblRoomImages] OFF
GO
SET IDENTITY_INSERT [dbo].[tblRooms] ON 
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (1, 1, N'101', N'Single', 1, CAST(900.00 AS Decimal(10, 2)), 1, N'Cozy single room with city view.', 0, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 0)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (2, 1, N'102', N'Double', 1, CAST(1300.00 AS Decimal(10, 2)), 2, N'Comfort double room with Nile view.', 1, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (3, 1, N'201', N'Suite', 2, CAST(2700.00 AS Decimal(10, 2)), 3, N'Executive suite with lounge area.', 1, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (4, 2, N'301', N'Double', 1, CAST(1400.00 AS Decimal(10, 2)), 2, N'Sea-facing double room.', 1, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (5, 2, N'302', N'Single', 2, CAST(2100.00 AS Decimal(10, 2)), 2, N'Deluxe room with balcony.', 1, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (6, 2, N'303', N'Single', 3, CAST(2500.00 AS Decimal(10, 2)), 4, N'Spacious family room.', 1, 1, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
...
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (9, 4, N'501', N'Double', 1, CAST(1200.00 AS Decimal(10, 2)), 2, N'Traditional desert-style double room.', 0, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (10, 4, N'502', N'Single', 2, CAST(2000.00 AS Decimal(10, 2)), 2, N'Deluxe tent-style accommodation.', 1, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (11, 5, N'601', N'Single', 1, CAST(950.00 AS Decimal(10, 2)), 1, N'City single with modern design.', 0, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (12, 5, N'602', N'Suite', 2, CAST(2400.00 AS Decimal(10, 2)), 3, N'Penthouse suite with skyline view.', 1, 0, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
INSERT [dbo].[tblRooms] ([room_id], [hotel_id], [room_number], [room_type], [beds_count], [price], [max_guests], [description], [breakfast_included], [pets_allowed], [created_at], [available]) VALUES (13, 5, N'603', N'Single', 3, CAST(2600.00 AS Decimal(10, 2)), 4, N'Family room with extra beds.', 1, 1, CAST(N'2025-10-23T17:02:34.0000000' AS DateTime2), 1)
GO
...
GO
INSERT [dbo].[tblUsers] ([user_id], [fullname], [email], [password_hash], [phone], [age], [role], [imagepath], [country], [status], [created_at], [hotel_id]) VALUES (6, N'kiro magdy', N'kiro@gmail.com', N'$2a$11$kHqvNuFWdCRHqkljrtgoUOjh.LNQ/XJuAtcclsmVX12OZ3R18TUbG', N'01200000000', 24, N'admin', NULL, N'Egypt', N'active', CAST(N'2025-10-25T22:26:10.4170091' AS DateTime2), NULL)
GO
...
GO
INSERT [dbo].[tblUsers] ([user_id], [fullname], [email], [password_hash], [phone], [age], [role], [imagepath], [country], [status], [created_at], [hotel_id]) VALUES (14, N'staffuser', N'staff@gmail.com', N'$2a$11$xSVS2jx1MlgCUyeidh9pfOlClXTGTATW25PydLt8Xy65pCbDPNhJO', N'01222222222', 23, N'staff', NULL, N'Egypt', N'active', CAST(N'2025-10-28T23:54:45.2801898' AS DateTime2), 3)
GO
INSERT [dbo].[tblUsers] ([user_id], [fullname], [email], [password_hash], [phone], [age], [role], [imagepath], [country], [status], [created_at], [hotel_id]) VALUES (15, N'kiro', N'kiro7@gmail.com', N'$2a$11$193yV.fwggt/LyruM1bOxu47ZgAVL64IRSGlKnaz/K9ExZGSwwvHS', N'01200000000', NULL, N'customer', N'/images/profiles/Unknown_person.jpg', NULL, N'active', CAST(N'2025-11-21T16:47:25.9018476' AS DateTime2), NULL)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__lkpAmeni__72E12F1B6FB36A1B]    Script Date: 12/6/2025 6:49:46 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__tblBooki__BADA455927423170]    Script Date: 12/6/2025 6:49:46 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__tblHotel__72E12F1BED7C40EC]    Script Date: 12/6/2025 6:49:46 PM ******/
ALTER TABLE [dbo].[tblHotels] ADD UNIQUE NONCLUSTERED 
(
	[name] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
/****** Object:  Index [UQ__tblRevie__5DE3A5B0889ABF13]    Script Date: 12/6/2025 6:49:46 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__tblUsers__AB6E616422F1317D]    Script Date: 12/6/2025 6:49:46 PM ******/
